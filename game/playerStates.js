...
export class Falling extends State {
  ...
  enter() {
    if (this.game.player.onGround()) this.player.vy -= 30;
    this.game.player.frameX = 0;
...
export class Rolling extends State {
  ...
  handleInput(input) {
    this.game.particles.push(new Fire(this.game, this.game.player.x+this.game.player.width*0.5, this.game.player.y+this.game.player.height*.5));
